                ...
                <div class="card-body bg-green text-black">
                    <form method="POST" action="{{ route('client.update', $client->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="numero" type="integer" class="form-control @error('number') is-invalid @enderror" name="numero" value="{{$client->numero}}" required autocomplete="numero" autofocus>

...
@section('content')
  <div class="my-3 p-3 bg-body rounded shadow-sm d-block text-black "id="Fondinter">
    <h3 class="text-center">Liste des appareils reparés & récuperés</h3>
                  ...
                  @foreach($reparations as $reparation)
                      <tr>
                          ...
                          <td>
                            ...
                            <form id="form-{{$reparation->id}}" action="{{route('reparation.supprimer',['reparation'=>$reparation->id])}}" method="post">
                              @csrf

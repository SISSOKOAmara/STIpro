...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a href="{{route('tache.list.all2')}}" class="navbar-brand btn btn-primary">Tout</a>
  <a href="{{route('tache.list2')}}" class="navbar-brand btn" style="background-color: orangered">Actuel</a>
  {{-- <a href="{{route('tache.listPreview2')}}" class="navbar-brand btn btn-success">Précédent</a> --}}
